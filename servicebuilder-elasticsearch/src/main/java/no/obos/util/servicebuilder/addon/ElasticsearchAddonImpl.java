...
//    public static ElasticsearchAddon defaults = new ElasticsearchAddon(null, null, null, null, null, null, null, null, null, null, 0, null, true);
    public static ElasticsearchAddonImpl defaults = new ElasticsearchAddonImpl(null, null, null, null, 0);
...
//    }
    ...
    public ElasticsearchAddonImpl client(Client client) {
        return withClient(client);
    }

    @Override
    public Addon withProperties(PropertyProvider properties) {
        String prefix = Strings.isNullOrEmpty(clientname) ? "" : clientname + ".";
