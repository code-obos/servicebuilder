...
public class MetricsAddonTest {
    ...
    public void healthcheck_with_addons() {
        ...
        assertThat(call.readEntity(String.class)).isEqualTo("{\"Thread deadlocks\":{\"healthy\":true},\"test: http://no.way.this.is.a.valid.address.zzz:23456/s3.0\":{\"healthy\":false,\"message\":\"no.way.this.is.a.valid.address.zzz\"}}");
    }
